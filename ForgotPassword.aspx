...
<body class="fp-page">
   <div class="fp-box">
        <div class="logo">
            <a href="javascript:void(0);">Visionary Life Science</a>
        ...
        <div class="card">
            <div class="body">
                <form id="forgot_password" runat="server">
                    ...
                    <asp:Button ID="btnForgotPwd" runat="server" Text="RESET MY PASSWORD" class="btn btn-block btn-lg bg-pink waves-effect" OnClick="btnForgotPwd_Click"/>
                    <br />
                    <br />
