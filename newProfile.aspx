<%@ Page Title="" Language="C#" MasterPageFile="~/EnterpriseMasterPage.master" AutoEventWireup="true" CodeFile="newProfile.aspx.cs" Inherits="newProfile" %>
                    ...
                    <div class="card profile-card">
                        ...
                        <div class="profile-body">
                            ...
                            <div class="content-area">
                                ...
                                <p style="text-align:center;">Web Software Developer</p>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane fade in" id="profile_settings">
                                        <form class="form-horizontal">
                                            <div class="form-group">
                                                <label for="OldPassword" class="col-sm-3 control-label">Name Surname</label>
                                                <div class="col-sm-9">
                                                    <div class="form-line">
                                            ...
                                            <div class="form-group">
                                                <label for="NewPasswordConfirm" class="col-sm-3 control-label">Expriene</label>
                                                <div class="col-sm-9">
                                                    <div class="form-line">
